...
%
%  All citation keys verified from PDF metadata.
%  See paper/references.bib for full entries.
% ============================================================
...
We evaluate three publicly available instruction-tuned models under deterministic decoding (temperature $= 0$): Llama~3.1-8B-Instruct \citep{dubey2024llama}, Gemma~2-9B-IT \citep{gemmateam2024gemma}, and Qwen3-8B \citep{qwenteam2025qwen3}. Deterministic decoding is used to ensure reproducibility; inter-run agreement was confirmed to be 100\% across 3,438 step comparisons. All models were loaded with 4-bit quantisation and evaluated on a single A10 GPU (24\,GB VRAM).
